        ...
        >
          <div className="flex-1 space-y-4 w-full">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <button className="px-6 py-3 border border-text/20 text-sm hover:border-primary transition-colors text-left bg-surface rounded">All Regions</button>
              <button className="px-6 py-3 border border-text/20 text-sm hover:border-primary transition-colors text-left bg-surface rounded">Europe</button>
              <button className="px-6 py-3 border border-text/20 text-sm hover:border-primary transition-colors text-left bg-surface rounded">Asia Pacific</button>
              <button className="px-6 py-3 border border-text/20 text-sm hover:border-primary transition-colors text-left bg-surface rounded">Mediterranean</button>
            </div>
          </div>
      ...
      <section className="py-32 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[400px]">
            ...
            {!isLoading && !isError && destinations.map((dest, index) => (
              <motion.div
                initial={{ opacity: 0, y: 30 }}
